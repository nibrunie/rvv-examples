...
void poly_mult_baseline(polynomial_t* dst, polynomial_t lhs, polynomial_t rhs)
{
    ...
    assert(dst->coeffSize >= dst->degree + 1);
 ...
 * @param rhs right hand side input polynomial
*/
void poly_mult_mod_baseline(polynomial_t* dst, polynomial_t lhs, polynomial_t rhs, polynomial_t modulo)
{
    poly_mult_baseline(dst, lhs, rhs);
...
void poly_mult_scalar_opt(polynomial_t* dst, polynomial_t lhs, polynomial_t rhs, polynomial_t modulo)
{
    int d;
    assert(rhs.modulo == lhs.modulo);
    dst->degree = lhs.degree + rhs.degree;
...
poly_mult_bench_result_t poly_mult_mod_baseline_bench(polynomial_t* dst, polynomial_t* lhs, polynomial_t* rhs, polynomial_t* modulo, polynomial_t* golden) {
    return poly_mult_bench(dst, lhs, rhs, modulo, poly_mult_mod_baseline, golden);
}
...
poly_mult_bench_result_t poly_mult_mod_scalar_opt_bench(polynomial_t* dst, polynomial_t* lhs, polynomial_t* rhs, polynomial_t* modulo, polynomial_t* golden) {
    return poly_mult_bench(dst, lhs, rhs, modulo, poly_mult_scalar_opt, golden);
}
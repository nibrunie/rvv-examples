...
generated_data_t data_2op_int[] = {
    ...
    {.v={3, 0x1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-30"},

    {.v={0xdaadbeef1337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=62"},
    {.v={0xaadbeef1337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=58"},
    {.v={0xadbeef1337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=54"},
    {.v={0xdbeef1337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=50"},
    {.v={0xbeef1337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=46"},
    {.v={0xeef1337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=42"},
    {.v={0xef1337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=38"},
    {.v={0xf1337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=34"},
    {.v={0x1337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=30"},
    {.v={0x337cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=26"},
    {.v={0x37cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=22"},
    {.v={0x7cafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=18"},
    {.v={0xcafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=14"},
    {.v={0xafe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=10"},
    {.v={0xfe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=6"},
    {.v={0xe, 3}, .label="(pos-pos) small_divisor=3,  delta_ldc=2"},

    {.v={3, 0xdaadbeef1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-62"},
    {.v={3, 0xaadbeef1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-58"},
    {.v={3, 0xadbeef1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-54"},
    {.v={3, 0xdbeef1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-50"},
    {.v={3, 0xbeef1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-46"},
    {.v={3, 0xeef1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-42"},
    {.v={3, 0xef1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-38"},
    {.v={3, 0xf1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-34"},
    {.v={3, 0x1337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-30"},
    {.v={3, 0x337cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-26"},
    {.v={3, 0x37cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-22"},
    {.v={3, 0x7cafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-18"},
    {.v={3, 0xcafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-14"},
    {.v={3, 0xafe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-10"},
    {.v={3, 0xfe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-6"},
    {.v={3, 0xe}, .label="(pos-pos) small_divdend=3,  delta_ldc=-2"},

    {.v={0xdaadbeef1337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=48"},
    {.v={0xaadbeef1337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=44"},
    {.v={0xadbeef1337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=40"},
    {.v={0xdbeef1337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=36"},
    {.v={0xbeef1337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=32"},
    {.v={0xeef1337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=28"},
    {.v={0xef1337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=24"},
    {.v={0xf1337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=20"},
    {.v={0x1337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=16"},
    {.v={0x337cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=12"},
    {.v={0x37cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=8"},
    {.v={0x7cafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=4"},
    {.v={0xcafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=0"},
    {.v={0xafe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=-4"},
    {.v={0xfe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=-8"},
    {.v={0xe, 0xcafe}, .label="(pos-pos) med_divisor=0xcafe,  delta_ldc=-12"},

    {.v={0xdaadbeef1337cafe, 0x8007cafe}, .label="(pos-pos) large_divisor=0x8007cafe,  delta_ldc=32"},
    {.v={0xaadbeef1337cafe, 0x8007cafe}, .label="(pos-pos) large_divisor=0x8007cafe,  delta_ldc=28"},
    {.v={0xadbeef1337cafe, 0x8007cafe}, .label="(pos-pos) large_divisor=0x8007cafe,  delta_ldc=24"},
    {.v={0xdbeef1337cafe, 0x8007cafe}, .label="(pos-pos) large_divisor=0x8007cafe,  delta_ldc=20"},
    {.v={0xbeef1337cafe, 0x8007cafe}, .label="(pos-pos) large_divisor=0x8007cafe,  delta_ldc=16"},
    {.v={0xeef1337cafe, 0x8007cafe}, .label="(pos-pos) large_divisor=0x8007cafe,  delta_ldc=12"},
    {.v={0xef1337cafe, 0x8007cafe}, .label="(pos-pos) large_divisor=0x8007cafe,  delta_ldc=8"},
    {.v={0xf1337cafe, 0x8007cafe}, .label="(pos-pos) large_divisor=0x8007cafe,  delta_ldc=4"},

    {.v={0xdaadbeef13378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=48"},
    {.v={0xaadbeef13378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=44"},
    {.v={0xadbeef13378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=40"},
    {.v={0xdbeef13378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=36"},
    {.v={0xbeef13378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=32"},
    {.v={0xeef13378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=28"},
    {.v={0xef13378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=24"},
    {.v={0xf13378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=20"},
    {.v={0x13378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=16"},
    {.v={0x3378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=12"},
    {.v={0x378001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=8"},
    {.v={0x78001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=4"},
    {.v={0x8001, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=0"},
    {.v={0xafe, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=-4"},
    {.v={0xfe, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=-8"},
    {.v={0xe, 0x8001}, .label="(pos-pos) med_divisor=0x8001,  delta_ldc=-12"},

    {.v={0xdaadbeef1337cafe, -3}, .label="(pos-neg),  delta_ldc=62"},
    {.v={0xaadbeef1337cafe, -3}, .label="(pos-neg),  delta_ldc=58"},
    {.v={0xadbeef1337cafe, -3}, .label="(pos-neg),  delta_ldc=54"},
    {.v={0xdbeef1337cafe, -3}, .label="(pos-neg),  delta_ldc=50"},
    {.v={0xbeef1337cafe, -3}, .label="(pos-neg),  delta_ldc=46"},
    {.v={0xeef1337cafe, -3}, .label="(pos-neg),  delta_ldc=42"},
    {.v={0xef1337cafe, -3}, .label="(pos-neg),  delta_ldc=38"},
    {.v={0xf1337cafe, -3}, .label="(pos-neg),  delta_ldc=34"},
    {.v={0x1337cafe, -3}, .label="(pos-neg),  delta_ldc=30"},
    {.v={0x337cafe, -3}, .label="(pos-neg),  delta_ldc=26"},
    {.v={0x37cafe, -3}, .label="(pos-neg),  delta_ldc=22"},
    {.v={0x7cafe, -3}, .label="(pos-neg),  delta_ldc=18"},
    {.v={0xcafe, -3}, .label="(pos-neg),  delta_ldc=14"},
    {.v={0xafe, -3}, .label="(pos-neg),  delta_ldc=10"},
    {.v={0xfe, -3}, .label="(pos-neg),  delta_ldc=6"},
    {.v={0xe, -3}, .label="(pos-neg),  delta_ldc=2"},

    {.v={0xdaadbeef1337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=48"},
    {.v={0xaadbeef1337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=44"},
    {.v={0xadbeef1337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=40"},
    {.v={0xdbeef1337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=36"},
    {.v={0xbeef1337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=32"},
    {.v={0xeef1337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=28"},
    {.v={0xef1337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=24"},
    {.v={0xf1337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=20"},
    {.v={0x1337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=16"},
    {.v={0x337cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=12"},
    {.v={0x37cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=8"},
    {.v={0x7cafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=4"},
    {.v={0xcafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=0"},
    {.v={0xafe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=-4"},
    {.v={0xfe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=-8"},
    {.v={0xe, -0xcafe}, .label="(pos-neg) med_divisor=0xcafe,  delta_ldc=-12"},

    {.v={0xdaadbeef1337cafe, -0x8007cafe}, .label="(pos-neg) large_divisor=0x8007cafe,  delta_ldc=32"},
    {.v={0xaadbeef1337cafe, -0x8007cafe}, .label="(pos-neg) large_divisor=0x8007cafe,  delta_ldc=28"},
    {.v={0xadbeef1337cafe, -0x8007cafe}, .label="(pos-neg) large_divisor=0x8007cafe,  delta_ldc=24"},
    {.v={0xdbeef1337cafe, -0x8007cafe}, .label="(pos-neg) large_divisor=0x8007cafe,  delta_ldc=20"},
    {.v={0xbeef1337cafe, -0x8007cafe}, .label="(pos-neg) large_divisor=0x8007cafe,  delta_ldc=16"},
    {.v={0xeef1337cafe, -0x8007cafe}, .label="(pos-neg) large_divisor=0x8007cafe,  delta_ldc=12"},
    {.v={0xef1337cafe, -0x8007cafe}, .label="(pos-neg) large_divisor=0x8007cafe,  delta_ldc=8"},
    {.v={0xf1337cafe, -0x8007cafe}, .label="(pos-neg) large_divisor=0x8007cafe,  delta_ldc=4"},

    {.v={0xdaadbeef, -0xdaadbeef}, .label="(pos-neg),  delta_ldc=0"},
    {.v={0xdaadbeef, -0xdaadbeef}, .label="(pos-neg),  delta_ldc=0"},
    {.v={3, -0xdaadbeef1337cafe}, .label="(pos-neg),  delta_ldc=-62"},
    {.v={3, -0x1337cafe}, .label="(pos-neg),  delta_ldc=-30"},

    {.v={-0xdaadbeef, -0xdaadbeef}, .label="(neg-pos),  delta_ldc=0"},
    {.v={-0xdaadbeef1337cafe, 3}, .label="(neg-pos),  delta_ldc=62"},
    {.v={-0xaadbeef1337cafe, 3}, .label="(neg-pos),  delta_ldc=58"},
    {.v={-0xadbeef1337cafe, 3}, .label="(neg-pos),  delta_ldc=54"},
    {.v={-0xdbeef1337cafe, 3}, .label="(neg-pos),  delta_ldc=50"},
    {.v={-0xbeef1337cafe, 3}, .label="(neg-pos),  delta_ldc=46"},
    {.v={-0xeef1337cafe, 3}, .label="(neg-pos),  delta_ldc=42"},
    {.v={-0xef1337cafe, 3}, .label="(neg-pos),  delta_ldc=38"},
    {.v={-0xf1337cafe, 3}, .label="(neg-pos),  delta_ldc=34"},
    {.v={-0x1337cafe, 3}, .label="(neg-pos),  delta_ldc=30"},
    {.v={-0x337cafe, 3}, .label="(neg-pos),  delta_ldc=26"},
    {.v={-0x37cafe, 3}, .label="(neg-pos),  delta_ldc=22"},
    {.v={-0x7cafe, 3}, .label="(neg-pos),  delta_ldc=18"},
    {.v={-0xcafe, 3}, .label="(neg-pos),  delta_ldc=14"},
    {.v={-0xafe, 3}, .label="(neg-pos),  delta_ldc=10"},
    {.v={-0xfe, 3}, .label="(neg-pos),  delta_ldc=6"},
    {.v={-0xe, 3}, .label="(neg-pos),  delta_ldc=2"},
    {.v={-3, 0xdaadbeef1337cafe}, .label="(pos-neg),  delta_ldc=-62"},
    {.v={-3, 0x1337cafe}, .label="(pos-neg)delta_ldc=-30"},
};
 ...
 *
 *  @param invalid[inout] point to a flag set to a non-zero value if index is invalid
 *  @param index[in] index of the generated data to return
 *  @return the generated data
*/
generated_data_t data_gen_2op_int(int* invalid, int index) {
    *invalid = index >= (sizeof(data_2op_int) / sizeof(generated_data_t));
    if (!(*invalid)) {
        return data_2op_int[index];
    }
    return data_2op_int[0];
}

/** generic data generator for floating-point 2-operand instruction (double precision) */
generated_data_t data_gen_2op_fp64(int* invalid, int index) {
    *invalid = index >= (sizeof(data_2op_fp64) / sizeof(generated_data_t));
    if (!(*invalid)) {
        return data_2op_fp64[index];
    }
    return data_2op_fp64[0];
}

/** generic data generator for floating-point 2-operand instruction (single precision) */
generated_data_t data_gen_2op_fp32(int* invalid, int index) {
    *invalid = index >= (sizeof(data_2op_fp32) / sizeof(generated_data_t));
    if (!(*invalid)) {
...
#       endif
        ...
        for (unsigned benchId=0; benchId < sizeof(data_benchmarks) / sizeof(ubench_data_t); benchId++)
        {
            ...
            for (unsigned index = 0; ; index++) {
                int invalid = 0;
                generated_data_t bench_data = data_benchmarks[benchId].data_gen(&invalid, index);
                if (invalid) break;

                // benchmark result init
                ubench_result_t bench_result = {.errors = 0, .perf_count = 0};
    ...
    #               endif // VERY_VERBOSE
                    ...
                    bench_result = accumulate_ubench_result(bench_result, local_result);
                }
                // display results
                bench_result.perf_count = bench_result.perf_count / NUM_TESTS;
    ...
    #           else
                // condensed display
                printf("%s #%d, %s, %zu, %lu, %.3f, %.2f, %d\n", 
                    data_benchmarks[benchId].label, index, bench_data.label, n, bench_result.perf_count,
                    (double) bench_result.perf_count / (n * bench_result.elt_per_op),
                    (double) (n * bench_result.elt_per_op) / bench_result.perf_count,
                    bench_result.errors);
    #           endif

...
generated_data_t data_2op_int[] = {
    ...
    {.v={0xadbeef1337cafe, 3}, .label="(pos-pos) delta_ldc=54"},
    {.v={0xdbeef1337cafe, 3}, .label="(pos-pos) delta_ldc=50"},
    {.v={0xbeef1337cafe, 3}, .label="(pos-pos) delta_ldc=46"},
    {.v={0xeef1337cafe, 3}, .label="(pos-pos) delta_ldc=42"},
    {.v={0xef1337cafe, 3}, .label="(pos-pos) delta_ldc=38"},
    {.v={0xf1337cafe, 3}, .label="(pos-pos) delta_ldc=34"},
    {.v={0x1337cafe, 3}, .label="(pos-pos) delta_ldc=30"},
    {.v={0x337cafe, 3}, .label="(pos-pos) delta_ldc=26"},
    {.v={0x37cafe, 3}, .label="(pos-pos) delta_ldc=22"},
    {.v={0x7cafe, 3}, .label="(pos-pos) delta_ldc=18"},
    {.v={0xcafe, 3}, .label="(pos-pos) delta_ldc=14"},
    {.v={0xafe, 3}, .label="(pos-pos) delta_ldc=10"},
    {.v={0xfe, 3}, .label="(pos-pos) delta_ldc=6"},
    {.v={0xe, 3}, .label="(pos-pos) delta_ldc=2"},
    {.v={3, 0xdaadbeef1337cafe}, .label="(pos-pos) delta_ldc=-62"},
    {.v={3, 0xaadbeef1337cafe}, .label="(pos-pos) delta_ldc=-58"},
    {.v={3, 0xadbeef1337cafe}, .label="(pos-pos) delta_ldc=-54"},
    {.v={3, 0xdbeef1337cafe}, .label="(pos-pos) delta_ldc=-50"},
    {.v={3, 0xbeef1337cafe}, .label="(pos-pos) delta_ldc=-46"},
    {.v={3, 0xeef1337cafe}, .label="(pos-pos) delta_ldc=-42"},
    {.v={3, 0xef1337cafe}, .label="(pos-pos) delta_ldc=-38"},
    {.v={3, 0xf1337cafe}, .label="(pos-pos) delta_ldc=-34"},
    {.v={3, 0x1337cafe}, .label="(pos-pos) delta_ldc=-30"},
    {.v={3, 0x337cafe}, .label="(pos-pos) delta_ldc=-26"},
    {.v={3, 0x37cafe}, .label="(pos-pos) delta_ldc=-22"},
    {.v={3, 0x7cafe}, .label="(pos-pos) delta_ldc=-18"},
    {.v={3, 0xcafe}, .label="(pos-pos) delta_ldc=-14"},
    {.v={3, 0xafe}, .label="(pos-pos) delta_ldc=-10"},
    {.v={3, 0xfe}, .label="(pos-pos) delta_ldc=-6"},
    {.v={3, 0xe}, .label="(pos-pos) delta_ldc=-2"},
    {.v={3, 0x1337cafe}, .label="(pos-pos) delta_ldc=-30"},
